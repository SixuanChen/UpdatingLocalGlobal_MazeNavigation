...
<body>
    ...
    <div id="wrapper">
        ...
        <p><em>If you press the 'ESC' key during the task, you will end the task.</em> At this time, you will be given our feedback and thank you letter. You will be automatically assigned credit once you hit the submit button on the letter.</p>
        <p><em>If you exit from the task using any other method (e.g. closing the tab)</em>, we will not be able to conduct these follow-up procedures, and we will not be able to give you credit. If something happens to interrupt your task (e.g. power outage) please email the researchers with the date and time of your participation, so we can manually assign you credit.</p>
...
This means choosing to go up would retrace your steps. The blue circle is indicating that moving
 down will <em>probably</em> give you the shortest path to the exit.</p>
        ...
        <p>Across trials, the exit location might change, too. It will either be at the  <b style="color:Blue;">bottom left </b> or  <b style="color:Blue;">top right</b>.
The possibility of whether the exit is at the bottom right can be considered as the <b>global
probability</b>. 

<p>Please update what you think of the <b>local probability</b>(how trustyworthy the blue circle is) and <b>global probability</b> (how consistently the exit is at the <b style="color:Blue;">bottom left </b>) are by using
the sliders below. </p>
<p>As you navigate the maze you may feel that the reliability of the color circle (local probability) changes.
...
<p>We know it may be hard to give a crisp estimate of how reliable the local and global cues are.
   Therefore after each maze navigation, you will receive feedback about your subjective estimate
    of the probabilities. </p>
<p>We will also inform you about the minimum steps required to finish the maze you 
    just navigated so you can improve in the next maze. <b style="color:Tomato;">Please use as few steps as possible to finish the experiment. </b></p>

     
        <p>Press the 'Next' button to play one maze as a practice.For practice maze only, 
          the exit will be located at <b style="color:Blue;">bottom right</b>.</p>
